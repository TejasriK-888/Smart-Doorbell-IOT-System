...
def send_notification(image_path):
    ...
    bot.send_message(chat_id=OWNER_CHAT_ID, text="There is a stranger at your door!")
    with open(image_path, 'rb') as photo:
        bot.send_photo(chat_id=OWNER_CHAT_ID, photo=InputFile(photo))
...
while True:
    ...
    for (top, right, bottom, left), name in zip(face_locations, face_names):
        ...
        if name == "Stranger":
            ...
            arduino.write(b'0')
            image_path = "Stranger/stranger.jpg"
